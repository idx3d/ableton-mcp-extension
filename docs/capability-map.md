...
| --------------------------------- | ---------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| **Song/Set**                      | tempo, scale, root note, grid, cue points                                                      | tempo, cue point create/delete/rename                                                              | time signature write, transport (play/stop/record/position), arrangement loop, cue-point move (time is immutable) |
